...
import {
  deleteWarehouseItem,
  getListWarehouseItems,
  updateWarehouseItem
} from "../../client/warehouseItemClient.ts";
...
const WarehousePage = (): ReactElement => {
  ...
  keycloak.loadUserInfo().then(() => {
    roles = keycloak.userInfo.roles.includes(UserRoles.ROLE_ADMIN)
        || keycloak.userInfo.roles.includes(UserRoles.ROLE_MANAGER)
